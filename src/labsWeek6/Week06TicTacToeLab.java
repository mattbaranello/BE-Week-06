...
public class Week06TicTacToeLab {
	...
	public static void main(String[] args) {
		...
		while (winner.equals("") && allSquares <= 9) {
			...
			squareNumber = Integer.valueOf(numInput);
			
			if (squareNumber > 0 & squareNumber <= 9) {
				if (gameBoard.ifValidSetSquare(squareNumber, numInput, player)) {
					if (player.equals("X")) {
						player = "O";
					}
					else {
					...
					System.out.println("Square has already been filled. Please try again.");
				}
			}
